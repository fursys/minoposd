		...
		if (uavtalk_parse_char(c, &msg)) {
			...
			switch (msg.ObjID) {
				...
				case FLIGHTSTATUS_OBJID:
						...
						if ((osd_armed == 2) && (osd_armed_prev != 2)) 
						{
							engine_start_time = millis();
						}
						osd_armed_prev = osd_armed;
				break;
...
//				break;
				...
				case FLIGHTBATTERYSETTINGS_OBJID:
					osd_voltage_factor = uavtalk_get_float(&msg, FLIGHTBATTERYSETTINGS_OBJ_VOLTAGE_FACTOR);
					osd_voltage_zero = uavtalk_get_float(&msg, FLIGHTBATTERYSETTINGS_OBJ_VOLTAGE_ZERO);
				break;
#endif
				case POSITIONSTATE_OBJID:
					revo_PS_alt =  -1.0 * uavtalk_get_float(&msg, POSITIONSTATE_OBJ_DOWN);
				break;
#ifdef REVO_ADD_ONS
				case BAROSENSOR_OBJID:
					revo_baro_alt		= uavtalk_get_float(&msg, BAROALTITUDE_OBJ_ALTITUDE);
				break;
				...
				case OPLINKSTATUS_OBJID:
						...
						//oplm_RxGood = uavtalk_get_int8(&msg, 79);
				break;
#endif
#endif
#ifdef OP_DEBUG
